...
public class CPPopupEventQueue extends EventQueue {
    ...
    public void createPopupMenu(JTextComponent text) {
        cut = new CutAction("Вырезать", null);
        copy = new CopyAction("Копировать", null);
        paste = new PasteAction("Вставить", null);
        selectAll = new SelectAllAction("Выделить все", null);
